...
# ======================================================
# CONFIGURAÇÃO DE PATH (compatível com Render)
# ======================================================
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
DB_PATH = os.path.join("/tmp", "database.db")

# Garante que o Python encontre módulos locais
...
def raads_test():
    if request.method == 'POST':
        ...
        cursor.execute("""
            ...
            (nome, email, tipo_teste, pontuacao_total, detalhes)
            VALUES (?, ?, ?, ?, ?)
